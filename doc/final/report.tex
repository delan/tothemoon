...
any confusion of the various user privileges. Our main approach was to figure
out the solutions for the larger problems as a group, and then to allocate
tasks to be solved by assorted group members by the end of the next sprint.
...
Our first goal with user stories was to group them into 3 groups representing
their priority for completion with 1 being highest and 3 being lowest. In the
highest priority group we placed stories we believed to be related to core
parts of the system. The second group were stories that enhanced the core
functionality of the system and added features and other useful tools for the
users. The lowest priority group were stories that enhanced ease of access and
usability as well as features that were not core functionality.

In the first priority tier of user stories we placed any stories about login
features and user levelling. We felt that this was core to the system because
the users would have different permissions and access. There were quite a few
stories relating to logging in and being able to perform their functions from
that. Out of the seven user stories that were decided to be priority one, three
were relating to log in functions.
...
be able to log in and approve requests. From this we can assume that they what
...
all users can log in in the first part of the working system; therefore this
was classified as a first priority story.
...
The fourth story provides a good insight in to the power of the principal
