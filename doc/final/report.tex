...
\newcommand\figimg[3][\textwidth]{
	\begin{figure}
		\caption{{#3}.}
		\label{fig:#2}
		\quad\\\includegraphics[width={#1}]{{#2}.png}
	\end{figure}
}
...
\begin{landscape}
	...
	\begin{textblock}{270}(-33,-30)
		\figimg[280mm]{gantt}{the Gantt chart for this project}
	\end{textblock}
\end{landscape}
...
\begin{itemize}
	\item Django `is a high-level Python Web framework that encourages
...
\figimg{user0}{the dashboard as seen by a plebeian user}

\figimg{user2}{the dashboard as seen by an administrator}
...
\figimg{uml}{the Unified Modeling Language diagram for this prototype}

\figimg{erd}{the entity-relationship diagram for this prototype}
